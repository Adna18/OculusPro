...
import 'package:oftamoloska_desktop/models/recommendResult.dart';
 ...
 @override
  RecommendResult fromJson(data) {
   ...
   Future trainData() async {
    var url = "http://localhost:5116/RecommendResult/TrainModel";
  ...
  Future deleteData() async {
    var url = "https://localhost:7009/RecommendResult/ClearRecommendation";
    var uri = Uri.parse(url);
    var headers = createHeaders();
